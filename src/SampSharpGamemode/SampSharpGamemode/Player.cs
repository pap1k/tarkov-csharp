...
namespace SampSharpGamemode
{
    ...
    public class Player : BasePlayer
    {
        ...
        private void CMD_xui(int lvl)
        {
            PVars[PvarsInfo.admin] = true;
            PVars[PvarsInfo.adminlevel] = lvl;
            this.SendClientMessage($"Вам выдана админка {{fbec5d}}{lvl} {{ffffff}}уровня. Обратите внимание, что изменения не были внесены в базу.");
        }
    }
}