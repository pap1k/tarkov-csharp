...
namespace SampSharpGamemode.Players
{
    public class AuthSystem
    {
        public static void Start(Player player)
        {
            ...
            var WAIT_DLT = new MessageDialog("{f90023}Ошибка ввода TOTP ключа.", "{ffffff}Не удалость войти в аккаунт, введен неверный TOTP код. Это окно закроется через 5 секунд.", "");
